...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/red-credit-d552#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/red-credit-d552
```

A live public deployment of this template is available at [https://red-credit-d552.templates.workers.dev](https://red-credit-d552.templates.workers.dev)
